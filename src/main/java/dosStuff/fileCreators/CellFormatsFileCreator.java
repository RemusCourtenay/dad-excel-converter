 ...
 * @since 13/11/2020
 */
public class CellFormatsFileCreator implements FileCreator {
    ...
    public CellFormatsFileCreator(FileIOThreadManager fileIOThreadManager) {
        fileIOThreadManager.writeToFileWithComment(CELL_FORMATS_FILE_COMMENT, DEFAULT_FORMAT_TYPES);
    }
